...
- completing an assigned deliverable or adding an approved learning resource;
...
- valid contribution records already earned may remain when appropriate;
...
- trusted learning, assessment, or task-completion events;
