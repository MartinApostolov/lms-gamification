...
Learners may disengage because they feel isolated or have difficulty recovering after falling behind. Small groups create a manageable community for sharing understanding, coordinating practice, and preparing together.
...
Recognition may come only from a separate trusted action, such as completing an approved Study Group learning goal, an assigned group task, or an eligible Collaborative Challenge contribution.
...
- learners completing structured learning or preparation activities through groups;
