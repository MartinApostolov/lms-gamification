...
Achievements and Badges recognizes meaningful learner accomplishments across courses, programs, exam preparation, optional learning, Collaborative Challenges, and post-course knowledge retention.
...
- recognition of verified collaborative contribution and retained knowledge;
...
- verified Collaborative Challenge contributions and group results;
- Post-course Knowledge Refresher completion or maintained-knowledge results;
- optional exploration or competitive challenges;
...
- **Socializers — medium:** Study Group and Collaborative Challenge achievements can recognize meaningful cooperation.
...
- Collaborative contribution achievements require a trusted activity result, visible contribution rule, or auditable staff validation.
...
- Post-course Knowledge Refresher definitions and results;
...
- participation in optional learning, Collaborative Challenges, and Knowledge Refreshers;
...
- Study Groups, Collaborative Challenges, Post-course Knowledge Refreshers, exploration features, and competitive features may supply additional trusted award sources.
