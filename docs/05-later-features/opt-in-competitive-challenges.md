...
- explicit opt-in and withdrawal rates;
- participation and completion by challenge format;
- percentage of participants improving a personal best;
- distribution of participation and results across late and early enrollees;
- team members meeting visible individual-contribution requirements;
- privacy changes, disputes, corrections, and invalidated scores;
- learner feedback on fairness, motivation, and discouragement;
- whether competition supports later progress, exam participation, or completion.

Success is fair and voluntary challenge participation, not maximizing public ranking exposure.
